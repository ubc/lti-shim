...
class ReturnTest extends LtiBasicTestCase
{
    ...
    private const NONCE = 'SomeNonceThatWasNotGeneratedByTheShim';
    ...
    protected function setUp(): void
    {
        ...
        // Note that the base param contains a nonce that wasn't generated using
        // Nonce::create(). This is to simulate the fact that the nonce was
        // generated by the target tool and not by the shim. We need to make
        // sure that the shim properly stores this into our nonce store.
        $this->baseParams =
            ['JWT' => $this->createToken(self::NONCE, $this->baseClaims)];
    }
